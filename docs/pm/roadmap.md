...
| 10 | **Valuation — VORP dollars, ceilings, price curve, Edge ([#20](https://github.com/GartRuzza/kerfuffle_gart_dash_v2/issues/20))** | Stage 2 ([D-13](../decision_log.md)): last-starter replacement (QB24/RB~34/WR~34/TE~17/DST12) → cap dollars → **league-generic + roster-aware ceilings**; price curve (2025 KERFUFFLE + current rosters; TRUFFLE off); **Edge = price − ceiling**; single-season value, dynasty as context; drillable. **Unblocked 2026-08-26** — gate decision #11 resolved (proceed, after the D-16 core fix); the next build. | #19 gate (decision #11) — **resolved, proceed** |
