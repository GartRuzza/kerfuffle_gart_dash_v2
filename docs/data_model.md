...
**Last updated:** 2026-08-26 · **Latest migration:** `db/migrations/004_historical_data.sql` (the issue-#17 historical layer — three tables; `003` is the D-12 superflex display board; `002` is the issue-#12 review fixes; `001` is the D-10 normalized layer + the D-11 dead-cap/Practice-Squad decision)
